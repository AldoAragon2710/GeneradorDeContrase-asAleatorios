...
function generar(){
    ...
    if(numeroDigitado<8){
       return alert("los caracteres deben ser mayor o igual a 8");
    }
    let password = '';
...
function validarContrasena(contrasenaGenerada){
    ...
    if (validacion) {
        ...
        messageElement.textContent = 'Contraseña débil. Debe tener al menos una letra mayúscula y un caracter especial.';
        messageElement.classList.remove('strong');
